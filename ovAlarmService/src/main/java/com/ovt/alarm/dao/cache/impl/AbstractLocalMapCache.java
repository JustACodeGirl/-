 ...
 * May 27, 2015
 */
package com.ovt.alarm.dao.cache.impl;
...
import com.ovt.alarm.common.model.LRUMap;
import com.ovt.alarm.common.utils.CollectionUtils;
import com.ovt.alarm.dao.cache.LocalCacheManager;
import com.ovt.alarm.dao.cache.MapCache;
...
public abstract class AbstractLocalMapCache<K, V> implements MapCache<K, V>
{
    ...
    /* (non-Javadoc)
     * @see com.ovt.doorbell.payment.dao.cache.Cache#preLoad()
     */
    @Override
    public void preLoad()
    {
